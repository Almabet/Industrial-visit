  ...
  <div class="box">
    ...
    <div class="box-body">
	  ...
	  foreach($records as $rec) {
        ...
        <tr>
          <td><?php echo $idx++; ?></td>
          <td><a href="<?php echo WEB_ROOT; ?>views/?v=USER&ID=<?php echo $user_id; ?>" style="color:red"><?php echo strtoupper($user_name); ?></a></td>
		  ...
		  <td><?php if($status == "PENDING") {?>
            <a href="javascript:approve('<?php echo $user_id ?>');" style="color:red">Approve</a>&nbsp;/
			&nbsp;<a href="javascript:decline('<?php echo $user_id ?>');" style="color:red">Denied</a>&nbsp;/
			&nbsp;<a href="javascript:deleteUser('<?php echo $user_id ?>');" style="color:red">Delete</a>
            <?php } else { ?>
			<a href="javascript:deleteUser('<?php echo $user_id ?>');" style="color:red">Delete</a>
			<?php }//else ?>
          </td>
