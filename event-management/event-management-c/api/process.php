...
function bookCalendar() {
	...
	$departmentHead = $_POST['department_head'];
	$departmentHeadEmail = $_POST['department_head_email'];
	$whatsappNumber = $_POST['whatsapp_number'];
	$academicYear = $_POST['academic_year'];
	$permissionLetter = $_FILES['permission_letter']['name'];
	...
	$sql = "INSERT INTO tbl_reservations (uid, ucount, rdate, status, comments, bdate, college_name, college_code, department, department_head, department_head_email, whatsapp_number, academic_year, permission_letter) 
			VALUES ($userId, $ucount, '$bkdate', 'PENDING', '', NOW(), '$collegeName', '$collegeCode', '$department', '$departmentHead', '$departmentHeadEmail', '$whatsappNumber', '$academicYear', '$permissionLetter')";
	dbQuery($sql);
